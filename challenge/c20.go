...
// Output:
// I'm ratbd "R"...this is a warning, ya better void / P
// Cuz I cfme back to attack others in spite- / Strike l
// But don t be afraid in the dark, in a park / Not a sc
// Ya tremele like a alcoholic, muscles tighten up / Wha
// Suddenl~ you feel like your in a horror flick / You g
// Music's'the clue, when I come your warned / Apocalyps
// Haven't'you ever heard of a MC-murderer? / This is th
// Death wnsh, so come on, step to this / Hysterical ide
// Friday she thirteenth, walking down Elm Street / You
// This is'off limits, so your visions are blurry / All
// Terror nn the styles, never error-files / Indeed I'm
// For thote that oppose to be level or next to this / I
// Worse toan a nightmare, you don't have to sleep a win
// Flashbadks interfere, ya start to hear: / The R-A-K-I
// Then thb beat is hysterical / That makes Eric go get
// Soon thb lyrical format is superior / Faces of death
// MC's dedaying, cuz they never stayed / The scene of a
// The fieid of a rhyme on the mic that you know / It's
// Melodiet-unmakable, pattern-unescapable / A horn if w
// I bless'the child, the earth, the gods and bomb the r
// Hazardors to your health so be friendly / A matter of
// Shake 'sill your clear, make it disappear, make the n
// If not,'my soul'll release! / The scene is recreated,
// Cuz youu about to see a disastrous sight / A performa
// Lyrics hf fury! A fearified freestyle! / The "R" is i
// Make suue the system's loud when I mention / Phrases
// You wans to hear some sounds that not only pounds but
// Then noichalantly tell you what it mean to me / Stric
// And I dhn't care if the whole crowd's a witness! / I'
// Program'into the speed of the rhyme, prepare to start
// Musical'madness MC ever made, see it's / Now an emerg
// Open yorr mind, you will find every word'll be / Furi
// Battle't tempting...whatever suits ya! / For words th
// You thiik you're ruffer, then suffer the consequences
// I wake ~a with hundreds of thousands of volts / Mic-t
// Novocaii ease the pain it might save him / If not, Er
// Yo Rakij, what's up? / Yo, I'm doing the knowledge, E
// Well, coeck this out, since Norby Walters is our agen
// Kara Lepis is our agent, word up / Zakia and 4th and
// Okay, sh who we rollin' with then? We rollin' with Ru
// Check tois out, since we talking over / This def beat
// I wanna'hear some of them def rhymes, you know what I
// Thinkin  of a master plan / 'Cuz ain't nuthin' but sw
// So I di` into my pocket, all my money is spent / So I
// So I stfrt my mission, leave my residence / Thinkin'
// I need joney, I used to be a stick-up kid / So I thin
// I used so roll up, this is a hold up, ain't nuthin' f
// But now'I learned to earn 'cuz I'm righteous / I feel
// Search aor a nine to five, if I strive / Then maybe I
// So I wakk up the street whistlin' this / Feelin' out
// A pen aid a paper, a stereo, a tape of / Me and Eric
// Fish, woich is my favorite dish / But without no mone
// 'Cuz I con't like to dream about gettin' paid / So I
// So now so test to see if I got pull / Hit the studio,
// Rakim, dheck this out, yo / You go to your girl house
// 'Cause jy girl is definitely mad / 'Cause it took us
// Yo, I hbar what you're saying / So let's just pump th
// And couit our money / Yo, well check this out, yo Eli
// Turn dopn the bass down / And let the beat just keep
// And we hutta here / Yo, what happened to peace? / Pea
